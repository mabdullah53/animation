import 'package:animationtutorial/all_animations/scrooll_list/scrool_list_model/scrol_list_model.dart';
import 'package:flutter/material.dart';

class ScrolList extends StatefulWidget {
  const ScrolList({super.key});

  @override
  State<ScrolList> createState() => _ScrolListState();
}

class _ScrolListState extends State<ScrolList> {
